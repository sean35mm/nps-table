...
const Table: React.FC<TableProps> = ({ data }) => {
	...
	return (
		<>
			<div className='flex justify-center overflow-y-scroll h-[800px] no-scrollbar'>
				<table className='w-3/4 m-10 table-fixed text-sm text-left text-gray-500 dark:text-gray-400'>
						...
						{currentEntries.map((timeEntry) => (
							...
							>
								<td className='px-6 py-4'>
									{
										data.find((entry) => entry.userId === timeEntry.userId)
											?.name
									}
								</td>
